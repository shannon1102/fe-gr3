...
export default function ChatBox({currentChat,messages,setMessages,newMessage,sendSubmit,currUserId,setNewMessage}) {
  ...
  return (
    <div className={classes.container}>
      <Paper className={classes.paper} zDepth={2}>
        ...
        <MessageInput setNewMessage={setNewMessage} setMessages={setMessages} newMessage={newMessage} sendSubmit={sendSubmit} />
      </Paper>
    </div>
  );
}
